...
<i>The I2C address for my display is 0x3C.</i> But, for certain displays, it is mentioned that DC>>GND-->I2C addrees=0x3D. One should test and ascertain the I2C address before its use. The following picture shows the I2C address displayed on OLED.
<p align="center">
